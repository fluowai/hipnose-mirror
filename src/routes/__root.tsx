...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hipnoterapia profissional com Ton Lucas." },
      { name: "author", content: "Ton Lucas" },
      { property: "og:title", content: "Ton Lucas | Hipnose e Psicologia" },
      { property: "og:description", content: "Hipnoterapia profissional com Ton Lucas." },
